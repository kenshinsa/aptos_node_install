...
echo "export WORKSPACE=\"$HOME/testnet\"" >>$HOME/.bash_profile
. $HOME/.bash_profile
...
cd $HOME/testnet
wget -O $HOME/testnet/docker-compose.yaml https://raw.githubusercontent.com/aptos-labs/aptos-core/main/docker/compose/aptos-node/docker-compose.yaml
wget -O $HOME/testnet/validator.yaml https://raw.githubusercontent.com/aptos-labs/aptos-core/main/docker/compose/aptos-node/validator.yaml
#wget -O fullnode.yaml https://raw.githubusercontent.com/aptos-labs/aptos-core/main/docker/compose/aptos-node/fullnode.yaml

aptos genesis generate-keys --assume-yes --output-dir $HOME/testnet

aptos genesis set-validator-configuration \
    --keys-dir $HOME/testnet --local-repository-dir $HOME/testnet \
...
wget -O $HOME/testnet/framework.zip https://github.com/aptos-labs/aptos-core/releases/download/aptos-framework-v0.2.0/framework.zip
unzip -o framework.zip
aptos genesis generate-genesis --assume-yes --local-repository-dir $HOME/testnet --output-dir $HOME/testnet
sleep 2
